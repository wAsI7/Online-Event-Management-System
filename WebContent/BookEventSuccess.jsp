...
<div class="container">
 ...
 <div class="transbox">
    <p style="text-align:center;font-size:300%;font-family:;color:white"><b>Your Event is Successfully Booked</b></p><hr>
    <p style="text-align:center;font-size:150%;color:white">Check the Status of your event after 3 hours.</p>
    <p style="text-align:center;font-size:120%;color:white">Click here to go back to<a href="BookEvent.jsp"> Book Event</a> Page</p>
  </div>
