...
%>
 ...
 <div class="transbox">
 	...
 	<p style="text-align:center;font-size:300%;font-family:;color:white"><b>Events</b></p><hr>
 	<form>
 	<table align="center">
 		<tr>
 		...
 		%>	
 			...
 			<tr>
		 		...
		 		<td><p style="text-align:center;font-size:120%; color:white;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="eventsaction.jsp?id=<%=id%>"><%=rs.getString(9) %></a></p></td>
		 	</tr>
		 	<%}%>
 		</table>
 	<hr>
