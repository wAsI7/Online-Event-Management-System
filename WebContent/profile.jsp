...
%>
 ...
 <div class="transbox">
 	<p style="text-align:center;font-size:300%; color:white;"><b>My Profile</b></p>
   <hr><p style="text-align:center;font-size:200%; color:white;">Name: <%=name %></p></br>
   <p style="text-align:center;font-size:200%; color:white;">Email: <%=email %></p></br>
   <p style="text-align:center;font-size:200%; color:white;">Phone: <%=phone %></p>
   <hr>
  </div>
