...
<div class="container">
 ...
 <div class="transbox">
    <form action="loginaction.jsp">
        <fieldset>
            <legend style="text-align:center;font-size:300%;font-family:;"><b>Login</b></legend>
                ...
                <hr>
                <a href="newuser.jsp"  ><button type="button" class="btn btn-primary center-block">New User?</button></a>
        </fieldset>
    </form>
  </div>
