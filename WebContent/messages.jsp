...
<div class="container">
 ...
 <%
	String name="",subject="",phone="";
	ResultSet rs=st.executeQuery("select * from contact");
	
%>

 <div class="transbox">
    <p style="text-align:center;font-size:300%;font-family:;color:white"><b>Messages</b></p><hr>
    ...
    <table align="center">
 		...
 		<td><p style="text-align:center;font-size:120%; color:white;"><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSubject</b></p></td>
 		</tr>
 		<%
 		int count=0;
 		while(rs.next()){
 		...
 		%>		 		
		 		...
		 		<td><p style="text-align:center;font-size:120%; color:white;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=subject %></p></td>
		 		<%} %>
 		</table>
